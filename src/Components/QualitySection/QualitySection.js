...
const QualitySection = () => {
    ...
    return (
        <div className='mt-24 bg-[#F8FAFF] py-24'>
            <div className='w-5/6 mx-auto grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 xl:gap-6 lg:gap-6 md:gap-16 gap-16 sm:gap-16 items-center'>
