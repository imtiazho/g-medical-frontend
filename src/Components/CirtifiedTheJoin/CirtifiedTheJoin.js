            ...
            <div className='w-9/12 h-full mx-auto'>
                ...
                <div className='flex flex-col justify-center items-center h-full z-10 text-center gap-10 py-14'>
                    <span>
                        ...
                        <p className='w-9/12 mx-auto text-white z-10 relative font-light'>One of the first major discoveries relevant to the field of pulmonology was the discovery of pulmonary circulation. Originally, it was thought that blood reaching the right side of the heart passed through small</p>
                    </span>
