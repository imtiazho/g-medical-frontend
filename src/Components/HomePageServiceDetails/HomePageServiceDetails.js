        ...
        <div>
            <div style={{ background: `url(${ourDoctorBanner})`, backgroundPosition: "center", backgroundSize: "cover" }} className='w-full lg:h-96 xl:h-96 md:h-auto relative'>
                ...
                <div className='flex justify-center items-center h-full z-10'>
                    <span>
                        <h1 className='text-center text-6xl mb-4 text-white z-10 relative'>Tooth Extraction</h1>
            ...
            <div className='w-5/6 mx-auto mt-14 grid grid-cols-2 gap-10 text-secondary'>
                ...
                <div className='mt-8 flex flex-col gap-8'>
                    ...
                    <p className='text-lg'>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine. I am so happy, my dear friend, so absorbed in the exquisite sense.</p>
                    <div className='flex flex-col gap-8 w-1/2'>
                        <span className='grid grid-cols-3 gap-4'>
                            <p className="font-bold text-black">Client</p>
                            <p className='col-span-2'>Apple Corp.</p>
                        </span>
                        <span className='grid grid-cols-3 gap-4'>
                            <p className="font-bold text-black">Skills</p>
                            <p className='col-span-2'>Marketing, Photoshop</p>
                        </span>
                        <span className='grid grid-cols-3 gap-4'>
                            <p className="font-bold text-black">Manager</p>
                            <p className='col-span-2'>Allan Smith</p>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className='w-5/6 mx-auto mt-24'>
                <div className='border-t py-10 grid grid-cols-4'>
                    ...
                    <p className='col-span-3 text-secondary leading-relaxed'>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                </div>
                <div className='border-t py-10 grid grid-cols-4'>
                    <h1 className='text-primary text-2xl font-bold'>Client’s Feedback</h1>
                    <p className='col-span-3 text-secondary leading-relaxed'>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine. I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now. When, whi</p>
                </div>
            </div>
        </div>
    );
