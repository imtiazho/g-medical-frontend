    ...
    return (
        <div className='grid grid-cols-3 gap-8'>
            <div onMouseLeave={() => setMousein(false)} onMouseEnter={() => setMousein(1)} className='flex flex-col gap-4'>
                ...
                <p className='text-center px-3 text-black font-medium text-xl'>Using ALD Films to Coat Medical Devices and Implants</p>
            </div>
            ...
            <div className='flex flex-col gap-4'>
                <div onMouseLeave={() => setMousein(false)} onMouseEnter={() => setMousein(7)} className="overflow-hidden relative">
                    <img className={`${mousein === 7 && "scale-110"} duration-500`} src={portfolioPic} alt="" />
                    {mousein === 7 && <span className='absolute bg-black opacity-50 w-full h-full bottom-0 rounded duration-500'></span>}
                </div>
                <p className='text-center px-3 text-black font-medium text-xl'>Using ALD Films to Coat Medical Devices and Implants</p>
            </div>
            <div className='flex flex-col gap-4'>
                <div onMouseLeave={() => setMousein(false)} onMouseEnter={() => setMousein(8)} className="overflow-hidden relative">
                    <img className={`${mousein === 8 && "scale-110"} duration-500`} src={portfolioPic} alt="" />
                    {mousein === 8 && <span className='absolute bg-black opacity-50 w-full h-full bottom-0 rounded duration-500'></span>}
                </div>
                <p className='text-center px-3 text-black font-medium text-xl'>Using ALD Films to Coat Medical Devices and Implants</p>
            </div>
            <div className='flex flex-col gap-4'>
                <div onMouseLeave={() => setMousein(false)} onMouseEnter={() => setMousein(9)} className="overflow-hidden relative">
                    <img className={`${mousein === 9 && "scale-110"} duration-500`} src={portfolioPic} alt="" />
                    {mousein === 9 && <span className='absolute bg-black opacity-50 w-full h-full bottom-0 rounded duration-500'></span>}
                </div>
                <p className='text-center px-3 text-black font-medium text-xl'>Using ALD Films to Coat Medical Devices and Implants</p>
            </div>
        </div>
